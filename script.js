...
const words = [
  'sigh','tense','airplane','south','east','west','carrot','ball','pies','juice','warlike','bad','north',
  'dependent','steer','silver','highfalutin','superficial','quince','eight','feeble','admit','drag',
  'loving','abstraction','inheritance','polymorphism','encapsulation','overloading','obedient','discipline',
